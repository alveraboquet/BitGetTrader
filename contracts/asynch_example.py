...
m = MarketApi("bg_0d456f8fe40db4bcfc8300b4e6242b75","74de60c68c9ea07d20b13aa0c6d849668810fcb71993434a33469f65fc71152b","meyerClaire30", use_server_time=False, first=False)
...
series = asyncio.run(z.getSeries("BTCUSDT_UMCBL", str(timeframe),adjTime-difference, int(adjTime), True))
